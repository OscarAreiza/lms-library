...
This branch implements Return + history (HU-07); Create lands on HU-06's own branch and
combines when merged.
...
├── application/usecase/  → ReturnLoan, SearchLoans (HU-07)
