...
// around LoanRegistrationService — the actual cross-service coordination
// (Student eligibility, Book availability, Loan creation) lives in the
// domain service, per library-docs/02-domain/entities-and-rules.md
// ("Domain Services").
